...
- **轻量高效**：特别设计的码表，极致的提示速度和极低的内存占用（20 KB）
- **广泛兼容**：已对主流编程语言和数据Schema支持进行充分测试与兼容
...
|  **五笔86版**  |   首笔画对应的字母相加  |
|  **五笔98版**  |   首笔画对应的字母相加  |
|    **声笔**   |   同[**拼音**]，但首字母为 a、e、i、o、u 时，用 v 替代   |


## 命名规范

我们整理了一份[中文命名规范](https://gitee.com/remyzane/zh-code-spec/blob/master/README.md)，欢迎参考和一起完善！
...
- [PinYin.js](https://github.com/sxei/pinyinjs)：多音字词表的来源，同时该项目也是`PYFL`项目极简首字母码表的来源。
- **正在使用的你** —— 感谢你的尝试与信任！
